package com.example.icomp.real;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void setUpMap() {
        Marker manaus = mMap.addMarker(new MarkerOptions()
                .position(MANAUS)
                .title("Manaus - AM")
                .snippet("preview do Inferno"));

        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(MANAUS, 20));
    }
}
